...
export function buildRoomInvites(
  ...
  const agentText = [
    ...
    "Browser/page visual viewing and screenshot perception are allowed and expected when you are guessing: inspect the rendered canvas as the picture. Visually inspect at the first meaningful drawing, then again only when newer strokes materially change the scene; do not take a screenshot after every stroke.",
