...
export const PROMPT_DECK: readonly PromptCard[] = [
  ...
  { prompt: "robot gardener", category: "characters", aliases: ["gardening robot", "robot gardening"] },
  ...
  { prompt: "tiny dragon", category: "fantasy", aliases: ["baby dragon", "small dragon"] },
  { prompt: "train station", category: "travel", aliases: ["railway station"] },
  { prompt: "robot watering a plant", category: "characters", aliases: ["robot watering plant", "gardening robot"] },
  ...
  { prompt: "cactus wearing a cowboy hat", category: "characters", aliases: ["cowboy cactus", "cactus in cowboy hat"] },
  { prompt: "octopus playing drums", category: "music", aliases: ["drumming octopus", "octopus drummer"] },
